...
class XCostExtensionMetaclass(type):
    """
    ...
    def __call__(cls, *args, **kw):
        if not XCostExtensionMetaclass.instance:
            XCostExtensionMetaclass.instance = super().__call__(*args, **kw)
        return XCostExtensionMetaclass.instance
